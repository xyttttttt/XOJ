...
import com.xyt.xojbackendquestionservice.model.dto.user.*;
...
//        isBlank是否为真空，==null和==""以及各种长度的空格==" "都为空
    ...
    public BaseResponse<Page<User>> listUserByPage(@RequestBody UserQueryRequest userQueryRequest,
        ...
        QueryWrapper<User> wrapper = userService.getQueryWrapper(userQueryRequest);
    ...
    public BaseResponse<Boolean> updateMyUser(@RequestBody UserUpdateRequest userUpdateRequest) {
        ...
        boolean update = userService.updateUserPassword(userUpdateRequest);
