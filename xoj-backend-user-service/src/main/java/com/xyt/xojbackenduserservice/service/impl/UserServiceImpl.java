...
import com.xyt.xojbackenduserservice.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            user.setUserAvatar("https://xoj-judge.oss-cn-beijing.aliyuncs.com/2023/792fe53b8ae1f4280a70ce91720d412d.jpeg");
            user.setUserName("无");
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        String token = JwtUtils.getJwtToken(tokenMap);
    ...
    public boolean updateUserPassword(UserUpdateRequest userUpdateRequest) {
        ...
        String userInputOldPassword = userUpdateRequest.getUserPassword();
        ...
        //数据库中存储的旧密码
        String userOldPassword = user.getUserPassword();
        //将用户输入旧密码进行加密
        String encryptOldPassword = DigestUtils.md5DigestAsHex((SALT + userInputOldPassword).getBytes());
        if (!userOldPassword.equals(encryptOldPassword)){
            throw new BusinessException(ErrorCode.OPERATION_ERROR,"账号或密码错误");
        }
        //获取新密码
